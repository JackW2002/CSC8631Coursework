...
```{r countArchetypes, echo=FALSE,fig.cap="Columns Count Chart for Student Archetypes", fig.width=8, fig.height=4}
...
archetype_means = student_grades |>
    group_by(archetype) |>
