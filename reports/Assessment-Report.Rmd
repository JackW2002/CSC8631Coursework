...
This merged_enrolments data frame then had students correct_percent and archetypes added in the `08-Create-student-certificate` R script. In cases where students had multiple archetypes recorded the most recent one was used in a process similar to cycle 1 of analysis.
